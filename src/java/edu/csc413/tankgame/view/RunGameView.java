...
public class RunGameView extends JPanel {
    ...
    public static final String WINNER_IMAGE = "win.png";
    public static final String FULL_HEALTH = "fullHealth.png";
    public static final String HALF_HEALTH = "halfHealth.png";
    public static final String TWO_THIRDS_HEALTH = "twoThirdsHealth.png";
    public static final String DEAD_HEALTH = "deadHealth.png";
    public static final String LOSER_IMAGE = "gameOver.jpg";
    ...
    public static final double PLAYER_MOVEMENT_SPEED =2.0;
    public static final double AI_MOVEMENT_SPEED = 2.0;
    public static final double DUMB_AI_MOVEMENT_SPEED = 0.2;
    ...
    public static final double POWER_UP_X = 500.0;
    public static final double POWER_UP_Y = 270.0;
    public static final double POWER_UP_2_X = 300.0;
    public static final double POWER_UP_2_Y = 370.0;
